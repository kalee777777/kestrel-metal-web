...
const API = (function () {
  ...
  // ==================== Seed Data ====================
  function seedData() {
    if (getStorage('seeded') && getCollection('blog_posts').length >= 52 && getCollection('case_studies').length >= 8 && getCollection('glossary').length >= 67 && getCollection('content_drafts').length >= 1) return;
    ...
    mergeCollection('blog_posts', [
      ...
      { id: 101, title: 'Tips for Opening and Closing Barb Wire Gates', slug: 'blog-barb-wire-gates-tips', description: 'Practical safety tips and best practices for opening and closing barb wire gates without damaging the fence or risking injury.', cover_image: 'images/blog/blog-gates-hero.webp', category: 'How-To', tags: JSON.stringify(['how-to', 'barbed-wire', 'gates', 'safety']), section: 'featured', author: 'Kestrel Metal', read_time: '5 min read', status: 'published', is_ai_generated: false, created_at: '2026-01-12T00:00:00.000Z' },
      ...
      { id: 406, title: 'Hexagonal Wire Mesh: A Simple Solution with Global Impact', slug: 'blog-hexagonal-wire-mesh-global-impact', description: 'How a simple hexagonal wire mesh product delivers outsized impact in agriculture and construction globally.', cover_image: 'images/blog/blog-hex-mesh-hero.webp', category: 'Global', tags: JSON.stringify(['global', 'hexagonal', 'agriculture', 'impact']), section: 'product-posts', author: 'Kestrel Metal', read_time: '6 min read', status: 'published', is_ai_generated: false, created_at: '2025-03-15T00:00:00.000Z' },
      { id: 407, title: 'Kestrel Metal Expands Production Capacity', slug: 'blog-new-manufacturing-facility', description: 'Kestrel Metal announces expanded production capacity to better serve growing global demand for wire mesh.', cover_image: 'images/blog/blog-welded-mesh-roll-warehouse.webp', category: 'Company News', tags: JSON.stringify(['company-news', 'production', 'capacity']), section: 'product-posts', author: 'Kestrel Metal', read_time: '4 min read', status: 'published', is_ai_generated: false, created_at: '2025-04-26T00:00:00.000Z' },
      { id: 408, title: 'The Future of Wire Mesh in Sustainable Infrastructure', slug: 'blog-sustainable-infrastructure', description: 'How wire mesh is shaping greener, more sustainable infrastructure projects across the globe.', cover_image: 'images/blog/blog-sustainable-infrastructure.webp', category: 'Sustainability', tags: JSON.stringify(['sustainability', 'infrastructure', 'green']), section: 'product-posts', author: 'Kestrel Metal', read_time: '7 min read', status: 'published', is_ai_generated: false, created_at: '2025-10-25T00:00:00.000Z' },
      { id: 409, title: 'Understanding KESTREL WELDED MESH 711-714', slug: 'blog-welded-mesh-711-714', description: 'Technical breakdown of the KESTREL WELDED MESH 711-714 series and its recommended applications.', cover_image: 'images/blog/welded-mesh-711.webp', category: 'Product', tags: JSON.stringify(['product', 'welded-mesh', '711-714', 'technical']), section: 'product-posts', author: 'Kestrel Metal', read_time: '6 min read', status: 'published', is_ai_generated: false, created_at: '2025-11-10T00:00:00.000Z' },
      { id: 410, title: 'Introducing KESTREL WELDED MESH 715', slug: 'blog-welded-mesh-715', description: 'Meet the latest addition to the KESTREL WELDED MESH family and the features that set it apart.', cover_image: 'images/blog/welded-mesh-715.webp', category: 'Product', tags: JSON.stringify(['product', 'welded-mesh', '715']), section: 'product-posts', author: 'Kestrel Metal', read_time: '5 min read', status: 'published', is_ai_generated: false, created_at: '2025-12-05T00:00:00.000Z' },
      { id: 411, title: 'Welded Gabion vs. Twisted Gabion Baskets: Which Is Better for Your Project?', slug: 'blog-welded-vs-twisted-gabion', description: 'Understand the strengths of welded versus twisted gabion baskets to choose the right option for your build.', cover_image: 'images/blog/blog-gabion-welded-vs-twisted-hero.webp', category: 'Guide', tags: JSON.stringify(['guide', 'gabion', 'welded', 'twisted']), section: 'product-posts', author: 'Kestrel Metal', read_time: '8 min read', status: 'published', is_ai_generated: false, created_at: '2025-07-08T00:00:00.000Z' },
      { id: 412, title: 'Gabion Boxes Supplier: Find the Best for Your Project', slug: 'gabion-boxes-supplier-find-the-best-for-your-project', description: 'Eight practical criteria for evaluating gabion box suppliers — certifications, coating weight verification, and factory audits.', cover_image: 'images/blog/blog-gabion-supplier-hero.webp', category: 'Sourcing Guide', tags: JSON.stringify(['gabion', 'supplier', 'sourcing']), section: 'product-posts', author: 'Kestrel Metal', read_time: '8 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-09T00:00:00.000Z' },
      { id: 413, title: 'Galvanized Chain Link Fence: Specs, Benefits & Buying Guide', slug: 'galvanized-chain-link-fence-specs-benefits-buying-guide', description: 'Complete specification reference for galvanized chain link — gauges, mesh sizes, zinc coating classes, and how to read quotes.', cover_image: 'images/blog/blog-galvanized-chain-link-specs-hero.webp', category: 'Buying Guide', tags: JSON.stringify(['galvanized', 'chain-link', 'specs', 'buying-guide']), section: 'product-info', author: 'Kestrel Metal', read_time: '8 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-09T00:00:00.000Z' },
      { id: 920, title: 'Gabion Boxes Supplier: Your Ultimate B2B Guide', slug: 'gabion-boxes-supplier-your-b2b-sourcing-guide', description: 'How to evaluate gabion box suppliers — specs, certifications, and cost benchmarks for B2B buyers.', cover_image: 'images/blog/blog-gabion-market-hero.webp', category: 'Sourcing Guide', tags: JSON.stringify(['gabion', 'supplier', 'b2b', 'sourcing']), section: 'product-info', author: 'Kestrel Metal', read_time: '8 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-16T00:00:00.000Z' },
      { id: 921, title: 'Gabion Boxes Supplier: Your Guide to Quality & Cost', slug: 'gabion-boxes-supplier-your-guide-to-quality-cost', description: 'Key selection criteria, quality specs, and cost factors when sourcing gabion baskets.', cover_image: 'images/blog/blog-gabion-market-hero.webp', category: 'Sourcing Guide', tags: JSON.stringify(['gabion', 'supplier', 'quality', 'cost']), section: 'product-info', author: 'Kestrel Metal', read_time: '8 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-16T00:00:00.000Z' },
      { id: 922, title: 'Gabion Boxes Supplier: Your Trusted B2B Partner', slug: 'gabion-boxes-supplier-your-trusted-b2b-partner', description: 'Why supplier reliability matters for gabion projects, and how to verify it before ordering.', cover_image: 'images/blog/blog-gabion-market-hero.webp', category: 'Sourcing Guide', tags: JSON.stringify(['gabion', 'supplier', 'b2b', 'partner']), section: 'product-info', author: 'Kestrel Metal', read_time: '7 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-16T00:00:00.000Z' },
      { id: 923, title: 'Galvanized Chain Link Fence: The B2B Buyer\'s Guide', slug: 'galvanized-chain-link-fence-b2b-buyer-s-guide', description: 'Complete B2B buying guide for galvanized chain link fence — wire gauge, coating weight, and roll specs.', cover_image: 'images/blog/blog-gabion-market-hero.webp', category: 'Buying Guide', tags: JSON.stringify(['galvanized', 'chain-link', 'b2b', 'buying-guide']), section: 'product-info', author: 'Kestrel Metal', read_time: '9 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-16T00:00:00.000Z' },
      { id: 924, title: 'Galvanized Chain Link Fence: The B2B Buyer\'s Guide', slug: 'galvanized-chain-link-fence-the-b2b-buyer-s-guide', description: 'Specifications, pricing factors, and installation planning for galvanized chain link fence buyers.', cover_image: 'images/blog/blog-gabion-market-hero.webp', category: 'Buying Guide', tags: JSON.stringify(['galvanized', 'chain-link', 'b2b', 'buying-guide']), section: 'product-info', author: 'Kestrel Metal', read_time: '8 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-16T00:00:00.000Z' },
      { id: 925, title: 'Galvanized Chain Link Fence: The Ultimate B2B Buying Guide', slug: 'galvanized-chain-link-fence-ultimate-b2b-buying-guide', description: 'Everything B2B buyers need: zinc coating classes, mesh sizes, and supplier verification.', cover_image: 'images/blog/blog-chain-link-yard-hero.webp', category: 'Buying Guide', tags: JSON.stringify(['galvanized', 'chain-link', 'b2b', 'buying-guide']), section: 'product-info', author: 'Kestrel Metal', read_time: '10 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-16T00:00:00.000Z' },
      { id: 926, title: 'Galvanized Wire: The Ultimate B2B Buying Guide', slug: 'galvanized-wire-the-ultimate-b2b-buying-guide', description: 'Galvanized wire grades, coating standards, and ordering checklist for industrial buyers.', cover_image: 'images/banner/galvanized-wire-the-ultimate-b2b-buying-guide-hero.webp', category: 'Buying Guide', tags: JSON.stringify(['galvanized-wire', 'b2b', 'buying-guide']), section: 'product-info', author: 'Kestrel Metal', read_time: '8 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-16T00:00:00.000Z' },
      { id: 927, title: 'Galvanized Wire: Ultimate B2B Buying Guide (2025)', slug: 'galvanized-wire-ultimate-b2b-buying-guide-2025', description: 'Updated 2025 edition — market prices, spec verification, and logistics for galvanized wire.', cover_image: 'images/blog/blog-gabion-market-hero.webp', category: 'Buying Guide', tags: JSON.stringify(['galvanized-wire', 'b2b', 'buying-guide', '2025']), section: 'product-info', author: 'Kestrel Metal', read_time: '8 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-16T00:00:00.000Z' },
      { id: 928, title: 'Top 10 Wire Mesh Manufacturers in China: Comprehensive Guide', slug: 'top-10-wire-mesh-manufacturers-china-comprehensive-guide', description: 'How to navigate China\'s wire mesh manufacturing landscape and shortlist the right partner.', cover_image: 'images/banner/top-10-wire-mesh-manufacturers-china-comprehensive-guide-hero.webp', category: 'Market Guide', tags: JSON.stringify(['wire-mesh', 'manufacturers', 'china', 'top-10']), section: 'product-info', author: 'Kestrel Metal', read_time: '10 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-16T00:00:00.000Z' },
      { id: 929, title: 'Top 10 Welded Wire Mesh Manufacturers in China (2024 Updated)', slug: 'top-10-welded-wire-mesh-manufacturers-china-2024-updated', description: 'Updated rankings and evaluation criteria for welded wire mesh manufacturers in China.', cover_image: 'images/banner/top-10-welded-wire-mesh-manufacturers-china-2024-updated-hero.webp', category: 'Market Guide', tags: JSON.stringify(['welded-wire-mesh', 'manufacturers', 'china', 'top-10']), section: 'product-info', author: 'Kestrel Metal', read_time: '10 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-20T00:00:00.000Z' },
      { id: 930, title: 'How to Install 3D Panel Fence: Expert Guide for B2B', slug: 'install-3d-panel-fence-expert-guide-for-b2b', description: 'Step-by-step 3D welded panel fence installation — post spacing, tools, and common pitfalls.', cover_image: 'images/banner/install-3d-panel-fence-expert-guide-for-b2b-hero.webp', category: 'Installation', tags: JSON.stringify(['3d-panel-fence', 'installation', 'b2b']), section: 'tips', author: 'Kestrel Metal', read_time: '9 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-20T00:00:00.000Z' },
      { id: 931, title: 'Cattle Fence Roll: Durable Livestock Fencing Guide', slug: 'cattle-fence-roll-durable-livestock-fencing-guide', description: 'Choosing and installing cattle fence rolls — hinge joint vs fixed knot, heights, and tensioning.', cover_image: 'images/banner/cattle-fence-roll-durable-livestock-fencing-guide-hero.webp', category: 'Application', tags: JSON.stringify(['cattle-fence', 'livestock', 'fencing', 'application']), section: 'tips', author: 'Kestrel Metal', read_time: '8 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-20T00:00:00.000Z' },
      { id: 932, title: '358 Fence: Complete Guide to High-Security Mesh Fencing', slug: '358-fence-complete-guide-high-security-mesh-fencing', description: '358 anti-climb mesh explained — aperture, wire diameter, and high-security applications.', cover_image: 'images/banner/358-fence-complete-guide-high-security-mesh-fencing-hero.webp', category: 'Security', tags: JSON.stringify(['358-fence', 'high-security', 'mesh', 'anti-climb']), section: 'product-posts', author: 'Kestrel Metal', read_time: '9 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-20T00:00:00.000Z' },
      { id: 933, title: 'Razor Wire Guide: High-Security Perimeter Fencing', slug: 'razor-wire-guide-high-security-perimeter-fencing', description: 'Razor wire types (BTC/CBT), NATO-22 specs, and perimeter deployment best practices.', cover_image: 'images/banner/razor-wire-guide-high-security-perimeter-fencing-hero.webp', category: 'Security', tags: JSON.stringify(['razor-wire', 'high-security', 'perimeter', 'btc', 'cbt']), section: 'product-posts', author: 'Kestrel Metal', read_time: '9 min read', status: 'published', is_ai_generated: false, created_at: '2026-09-20T00:00:00.000Z' },
    ], 'slug');

    // Seed cases
    mergeCollection('case_studies', [
      { id: 1, title: 'Solar Farm Perimeter Security', slug: 'solar-farm-security', client: 'GreenEnergy Corp', location: 'Australia', category: 'energy', description: 'High-security fencing for a 50MW solar farm', content_md: '# Solar Farm Security Project\n\n## Background\n\nGreenEnergy Corp needed to secure their new 50MW solar farm...\n\n## Solution\n\nWe installed high-security chain link fence with concertina razor wire...\n\n## Results\n\n- 100% perimeter coverage\n- Zero security breaches in 6 months\n- Easy maintenance access', cover_image: 'images/blog/industry-energy.webp', status: 'published', static_url: 'case-study-solar-farm-perimeter-security.html', created_at: new Date(Date.now() - 86400000 * 30).toISOString() },
      { id: 2, title: 'Cattle Ranch Fencing Solution', slug: 'cattle-ranch-fencing', client: 'Outback Farms', location: 'Queensland, Australia', category: 'agriculture', description: 'Heavy-duty fencing for a 10,000-head cattle ranch', content_md: '# Cattle Ranch Project\n\n## Project Scope\n\nOutback Farms needed to fence 500 acres for their cattle operation...\n\n## Implementation\n\nInstalled heavy-duty ringlock fencing with steel posts...', cover_image: 'images/blog/app-cattle-livestock.webp', status: 'published', static_url: 'case-study-cattle-ranch-fencing.html', created_at: new Date(Date.now() - 86400000 * 45).toISOString() },
    ...
    setStorage('site_settings', {
      ...
      site_email: 'kalee@kestrelmetal.com',
