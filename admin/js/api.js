...
const API = (function () {
  ...
  function seedData() {
    ...
    setCollection('blog_posts', [
      ...
      { id: 3, title: 'Gabion Installation: Step-by-Step Guide', slug: 'gabion-installation-guide', description: 'Complete guide to installing gabion boxes', content_md: '# Gabion Installation Guide\n\nFollow these steps for successful gabion installation...\n\n## Preparations\n\nBefore you begin...\n\n## Step-by-Step\n\n1. Mark the area\n2. Excavate the foundation\n3. Compress the base\n4. Lay geotextile...', cover_image: '/images/blog-gabion-install-hero.webp', category: 'Installation', tags: JSON.stringify(['gabion', 'installation', 'guide']), section: 'tips', author: 'Kestrel Metal', read_time: '10 min read', status: 'published', is_ai_generated: false, created_at: new Date(Date.now() - 86400000 * 21).toISOString() },
    ]);
